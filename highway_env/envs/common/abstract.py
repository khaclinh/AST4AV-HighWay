...
class AbstractEnv(gym.Env):
    ...
    def __init__(self, config: dict = None) -> None:
        ...
        #define model to predict actions for controling vehicles from step fucntion in the env
        #self.model = DQN.load(r"C:/Users/qsar1/OneDrive/Documents/Projects/VinFast/highway-env-master/Examples/model5.zip")
        self.reset()
